...
(function($){
    ...
    $.fn.wBox = function(options){
        ...
        var wBoxHtml = '<div id="wBox"><div class="wBox_popup"><table><tbody><tr><td class="wBox_tl"/><td class="wBox_b"/><td class="wBox_tr"/></tr><tr><td class="wBox_b"><div style="width:10px;">&nbsp;</div></td><td><div class="wBox_body">' + (_this.YQ.noTitle ? '' : '<table class="wBox_title"><tr><td class="wBox_dragTitle"><div class="wBox_itemTitle">' + _this.YQ.title + '</div></td><td width="20px" title="关闭"  style="background-color:#1076c5"><div class="wBox_close"></div></td></tr></table> ') +
					...
					if (_this.YQ.requestType === "ajax") {
						...
						ifr.load(function(){
							try {
								...
								newH = _this.YQ.iframeWH.height - 25 - (_this.YQ.noTitle ? 0 : 30);
        ...
        function drag(){
            ...
            function move(e){
                ...
                if(e.clientY - dy<0){
                	...
                	if(e.clientY-dy>$win.height()-C.height()){
        ...
        this.close=function (){
            ...
            typeof _this.YQ.closeCall === 'function' ? _this.YQ.closeCall() : null;
        }
        /*
         * 触发click事件
         */		
